...
const Project = () => {
  ...
  <FeaturedProject
    ...
    summary={`Fresh or Trash is an AI-powered web application developed as our final capstone project during the Coding Camp 2026 Data Science Path. The platform helps automate fruit freshness inspection by classifying fresh and rotten fruits using a MobileNetV2 deep learning model, reducing human error and improving efficiency in quality control processes.

The application allows users to upload an image containing one or multiple fruits and receive real-time predictions with confidence scores. In addition to the prediction feature, the platform provides educational articles about fruit freshness, spoilage processes, and food waste awareness. Built with a modern full-stack architecture, the project combines AI, web technologies, and cloud deployment to deliver an accessible solution for supermarkets, warehouses, and agricultural industries.`}
